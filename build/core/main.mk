...
JZS_PATH_SOURCES := $(TOPDIR)zlingyin.source
BUILD_SYSTEM_JZS_EXTENSION := $(JZS_PATH_SOURCES)/build/android
...
ADDITIONAL_BUILD_PROPERTIES += net.bt.name=$(strip $(QS_BT_NAME))
else
...
subdir_makefiles := \
	$(shell build/tools/findleaves.py --prune=$(OUT_DIR) --prune=.repo --prune=.svn --prune=.git $(subdirs) Android.mk)
