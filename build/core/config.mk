...
COMMON_GLOBAL_CFLAGS:= -DANDROID -fmessage-length=0 -W -Wall -Wno-unused-parameter -Wno-unused -Winit-self -Wpointer-arith
...
ifdef BUILD_SYSTEM_JZS_EXTENSION
include $(BUILD_SYSTEM_JZS_EXTENSION)/config.mk 
endif
