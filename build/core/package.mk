...
$(call intermediates-dir-for,APPS,zlingyin-res,,COMMON)/package-export.apk:$(call intermediates-dir-for,APPS,framework-res,,COMMON)/src/R.stamp 
$(call intermediates-dir-for,APPS,zlingyin-res,,COMMON)/package-export.apk:$(call intermediates-dir-for,APPS,mediatek-res,,COMMON)/src/R.stamp 
...
framework_res_package_export := \
  ...
  ifneq ($(LOCAL_NO_LINGYINRES),true)
  ifneq ($(LOCAL_EXPORT_PACKAGE_RESOURCES),true)
	framework_res_package_export += \
		$(call intermediates-dir-for,APPS,zlingyin-res,,COMMON)/package-export.apk
  endif
  endif
