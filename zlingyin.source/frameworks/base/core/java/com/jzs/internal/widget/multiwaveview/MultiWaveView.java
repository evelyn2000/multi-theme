...
package com.jzs.internal.widget.multiwaveview;
...
public class MultiWaveView extends View {
    ...
    private void switchToState(int state, float x, float y) {
    	//android.util.Log.i("QsLog", "switchToState()==state:"+state);
        switch (state) {
            case STATE_IDLE:
                deactivateTargets();
...
//            }
    ...
    public int getResourceIdForTarget(int index) {
        final TargetDrawable drawable = ((index < mTargetDrawables.size()) ? mTargetDrawables.get(index) : null);
