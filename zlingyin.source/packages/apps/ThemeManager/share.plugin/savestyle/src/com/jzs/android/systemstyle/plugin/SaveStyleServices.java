...
//	        android.os.Build.changeQsUiStyle(nStyle, subkey);
//	        switch(nStyle){
//        	case ThemeManager.STYLE_IPHONE:
//        	case ThemeManager.STYLE_SAMSUNG:
//        	case ThemeManager.STYLE_HTC:
//        		android.os.Build.changeQsLockscreenStyle(nStyle);
//        		break;
//        	default:
//        		android.os.Build.changeQsLockscreenStyle(ThemeManager.STYLE_DEFAULT);
//        		break;
//        	}
	        
//	        String animfile="", shutanim="";
//	        animfile = String.format("boot%d.zip", nStyle);
//	        shutanim = String.format("shut%d.zip", nStyle);
//	        android.os.SystemProperties.set(QS_BOOT_ANIMATION_KEY, animfile);
//	        android.os.SystemProperties.set(QS_SHUT_ANIMATION_KEY, shutanim);
