...
zlingyin-res-source-path := APPS/zlingyin-res_intermediates/src
...
LOCAL_INTERMEDIATE_SOURCES := \
			...
			$(zlingyin-res-source-path)/com/jzs/internal/R.java \
			$(zlingyin-res-source-path)/com/jzs/R.java \
			$(zlingyin-res-source-path)/com/jzs/Manifest.java 

LOCAL_NO_STANDARD_LIBRARIES := true
LOCAL_JAVA_LIBRARIES := bouncycastle conscrypt core core-junit ext okhttp CustomProperties
LOCAL_JAVA_LIBRARIES += mediatek-common
LOCAL_JAVA_LIBRARIES += zlingyin.common 
...
include $(LOCAL_PATH)/../../$(JZS_PATH_SOURCES)/frameworks/config.mk
endif
...
LOCAL_ASPECTS_DIR :=aspect/frameworks/src

#Include aspectj-runtime in the framework.jar only when aop is enabled
...
zlingyin_res_R_stamp := \
        $(call intermediates-dir-for,APPS,zlingyin-res,,COMMON)/src/R.stamp
$(full_classes_compiled_jar): $(framework_res_R_stamp) $(mediatek_res_R_stamp) $(zlingyin_res_R_stamp)
# @}
...
framework_docs_LOCAL_JAVA_LIBRARIES += zlingyin.common 
...
#Include AspectJ Runtime availabel for all apps
include $(CLEAR_VARS)
