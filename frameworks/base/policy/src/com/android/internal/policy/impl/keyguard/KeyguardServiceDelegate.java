...
public class KeyguardServiceDelegate {
    ...
    public void setJzsPhoneCoverStatus(int status) {
        setJzsPhoneCoverStatus(status, false);
    }
    /* @hide */
    public void setJzsPhoneCoverStatus(int status, boolean forcehandle) {
        if(com.jzs.utils.ConfigOption.QS_SUPPORT_COVER){
            android.util.Log.i("Jzs.QsLog."+TAG, "jzsGetPhoneCover()==status:"+status+", mKeyguardService:"+mKeyguardService);
            if (mKeyguardService != null) {
                mKeyguardService.setJzsPhoneCoverStatus(status, forcehandle);
            }
        }
    }
}
