...
public:
     ...
     */
    virtual bool addAssetPath(const String8& path, void** cookie, const char* pkg = NULL);

    /*                                                                       
     * Convenience for adding the standard system assets.  Uses the
     * ANDROID_ROOT environment variable to find them.
     */
    virtual bool addDefaultAssets();
     ...
     */
    virtual void setConfiguration(ResTable_config& config, const char* locale = NULL);
...
protected:
    void jzsAddAssetFilePath(const char* path, const char* idmap);
    virtual bool checAndGetAssetFilePath(const String8& path, const char* pkg);    
#endif
};
