...
LOCAL_CFLAGS += -DGL_GLEXT_PROTOTYPES -DEGL_EGLEXT_PROTOTYPES -DCONFIG_MEDIATEK_WIFI_BEAM
ifneq ($(strip $(QS_BT_NAME)),)  
  LOCAL_CFLAGS += -D__QS_BT_NAME__=\"$(QS_BT_NAME)\"
endif
...
LOCAL_SHARED_LIBRARIES += libjzslyglobal
endif
LOCAL_CFLAGS += -DJZS_SUPPORT_LY_STYLE
LOCAL_STATIC_LIBRARIES += libjzscustom_p_jni
endif
...
include $(CLEAR_VARS)
ifeq ($(USE_JZS_GLOBAL_LIB), yes)
LOCAL_PREBUILT_LIBS := ../../../../$(JZS_PATH_SOURCES)/frameworks/base/common/prebuild/arm.lib/libjzscustom_p_jni.a
else
LOCAL_PREBUILT_LIBS := ../../../../$(JZS_PATH_SOURCES)/frameworks/base/common/prebuild/arm/libjzscustom_p_jni.a
endif
