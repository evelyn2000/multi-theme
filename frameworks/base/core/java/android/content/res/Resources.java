...
public class Resources {
    ...
    private static String sDefaultSkin; /// M: Theme manager
    ...
    public static int selectDefaultTheme(int curTheme, int targetSdkVersion) {
        return selectSystemTheme(curTheme, targetSdkVersion,
                ...
                com.jzs.R.style.AppTheme);//com.android.internal.R.style.Theme_DeviceDefault);
    }
    ...
    public void updateConfiguration(Configuration config,
        ...
        synchronized (mAccessLock) {
            ...
            boolean needClearCache = false;	/// M: Theme manager
            if (config != null) {
    ...
    public final void startPreloading() {
        synchronized (sSync) {
            ...
            sDefaultSkin = Configuration.getSkin(); /// M: Theme manager
        }
    }
    ...
    private Resources() {
        ...
        mConfiguration.skin = Configuration.getSkin(); /// M: Theme manager
        mMetrics.setToDefaults();
        updateConfiguration(null, null);
   ...
   /**
    ...
    private void loadPreloadedDrawableResources() {
        /* do not preload for theme resource
        try {
            sPreloaded = false;
            startPreloading();
    ...
    private String generateCurrentDensitySuffix() {
        ...
        if (density >= 120 && density < 160) {
            ...
            densityString = "mdpi/";
        /* M: tvdpi uses hdpi resource */
        } else if (density >= 213 && density < 320) {
            densityString = "hdpi/";
