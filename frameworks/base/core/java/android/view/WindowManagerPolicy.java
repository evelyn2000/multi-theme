...
public interface WindowManagerPolicy {
    ...
    public interface WindowState {
        ...
        /**
         * M: Check whether the window is belong to floating window. @{
         * @hide
         */
        ...
        /**
         * M: Get the floating region from the StackBox @{
        ...
        /**
         * M: Identify the window state is located at the focus stack box @{
         * @ return true if at the focus stack box. Otherwise, at the non-focus
         *               stack box.
         * @hide
         */
        public boolean isFocusStackBox();
        /// @}

        /**
         * M: When running layoutWindowLw at MtkPhoneWindowManager, it needs to
        ...
        /**
         * M: Identify the floating window is full for the floating stack
    ...
    public interface WindowManagerFuncs {
        ...
        /// M:[SmartBook] @{
        /**
         * Switch the inputmethod language 
         */
        ...
        /**
         * M: Move the floating window by the distance of X & Y @{
         * @ param disX the distance of X
         * @ param disY the distance of Y
         */
        public void moveFloatingWindow(int disX, int disY);

        /**
         * M: Resize flag : The default value is none.(Don't resize)
         */
        public static final int RESIZE_NONE  = 0;

        /**
         * M: Resize flag : Resize the up side border.
         */
        public static final int RESIZE_UP    = 1 << 0;

        /**
         * M: Resize flag : Resize the down side border.
         */
        public static final int RESIZE_DOWN  = 1 << 1;

        /**
         * M: Resize flag : Resize the left side border.
         */
        public static final int RESIZE_LEFT  = 1 << 2;

        /**
         * M: Resize flag : Resize the right side border.
         */
        public static final int RESIZE_RIGHT = 1 << 3;

        /**
         * M: Resize the floating window by the delta of X & Y @{
         * @ param direction The direction can RESIZE_UP, RESIZE_DOWN,
         *                   RESIZE_LEFT & RESIZE_RIGHT
         * @ param deltaX the delta of X
         * @ param deltaY the delta of Y
         */
        public void resizeFloatingWindow(int direction, int deltaX, int deltaY);

        /**
         * M: Enable focus frame to resize or move the floating window @{
         * @ param enable Enable the focus frame or not.
         */
