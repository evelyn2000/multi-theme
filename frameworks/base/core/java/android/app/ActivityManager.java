...
public class ActivityManager {
     ...
     * @hide
     */
    public static final int START_PERMISSION_USER_DENIED = -7;
    ...
    public int getLauncherLargeIconSize() {
        ...
        if(com.jzs.utils.ConfigOption.ENABLE_JZS_JARS
            ...
            final com.jzs.common.manager.IAppsManager appsManager = (com.jzs.common.manager.IAppsManager)mContext.getSystemService(com.jzs.common.manager.IAppsManager.MANAGER_SERVICE);
            if(appsManager != null){
                size = appsManager.getIconSize();
            }
        }
        if(size == 0)
