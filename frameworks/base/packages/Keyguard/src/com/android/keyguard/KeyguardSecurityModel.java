...
public class KeyguardSecurityModel extends JzsKeyguardSecurityModel {
    /**
     ...
     */
    protected boolean isBiometricUnlockSuppressed() {
	...
	protected String getSecurityModeString(){
		return String.valueOf(getSecurityMode());
	}
	...
	protected boolean isUsingVoiceWeakd(){
