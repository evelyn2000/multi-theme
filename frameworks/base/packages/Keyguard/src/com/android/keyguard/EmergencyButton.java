...
public class EmergencyButton extends Button {
    ...
    KeyguardUpdateMonitorCallback mInfoCallback = new KeyguardUpdateMonitorCallback() {
        ...
        /// M: [ALPS01635605] Fix ECC button doesn't show after service state changed.
        @Override
    ...
    public void takeEmergencyCallAction() {
        ...
        if (TelephonyManager.getDefault().getCallState()
            ...
            mEmergencyButtonExt.customizeEmergencyIntent(intent, getCurSlotId());
    ...
    void updateEmergencyCallButton(int phoneState) {
        ...
        boolean keyguardUtilShowEcc = mEmergencyButtonExt.showEccInNonSecureUnlock();
        /// M:CTA new feature
    ...
    private boolean eccButtonShouldShow(){
        ...
        return mEmergencyButtonExt.showEccByServiceState(isServiceSupportEcc, getCurSlotId());
    }
    ///  @}
