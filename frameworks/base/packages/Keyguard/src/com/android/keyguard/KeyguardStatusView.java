...
public class KeyguardStatusView extends GridLayout {
    ...
    protected void refresh() {
        ...
        if(true){
            java.text.SimpleDateFormat dateformate = (java.text.SimpleDateFormat)DateFormat.getDateFormat(mContext);
            if(dateformate != null){
                dateFormat = dateformate.toLocalizedPattern();
            } else {
                dateFormat = DateFormat.getBestDateTimePattern(locale,
